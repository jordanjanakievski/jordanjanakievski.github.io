...
function SelfEdu() {
	return (
		<div className={"content"}>
			...
			<figcaption>&emsp; &emsp; &mdash; Issac Asimov</figcaption>
			<p>
				...
				writer and in my communcation skills. Some of my main areas of interest
				include leadership, business, and personal development.
			</p>
		</div>
	);
}
