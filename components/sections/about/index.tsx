            ...
            <div className="flex flex-col items-center justify-center">
                <div className="flex lg:flex-row items-center justify-around lg:pb-16 pb-8 flex-col">
                    ...
                    <div className="lg:w-1/2">
                        ...
                        <br />
                        <p>
                            I am an undergrad studying computer science at the
                            University of Toronto. Having grown up in Seattle,
                            it seems that{" "}
                            <TooltipProvider>
                                <Tooltip>
                        ...
                        <br />
                        <p>
                            I like to solve hard problems that make a real
                            difference. Whether it be improving the experience
                            for a user or developing full systems with{" "}
                            <a
                            ...
                            , I have seen first-hand how improvements in
                            software can change the way one works. Because of
                            this, I am constantly trying to hone my craft and
                            find new opportunities to learn. Currently, I am
                            looking into contributing to some of my favorite
                ...
                <div className="flex lg:flex-row items-center justify-around flex-col">
                    <div className="lg:w-1/2">
                        <p>
                            When away from the keyboard, you can often find me
                            outdoors. From being on the water to hiking in the
                            mountains, it has become very important for me to
                            remain connected with nature. Sports are another way
                            I stay active and unwind. Both playing and
                            officiating give me the chance to connect with
                            others and enjoy some friendly competition.
                        </p>
                        <br />
                        <p>
                            <a
                            ...
                            has become a growing interest of mine. While I only
                            have a small{" "}
                            <a
                                className="underline text-blue-600"
                            ...
                            , I love learning about the movements and how each
                            watch tells a unique story about its wearer. I find
                            it interesting that you often develop a symbiotic
                            relationship with your timepieces, as they become a
                            part of your routine and are given life through use.
                        </p>
                        <br />
                    </div>
